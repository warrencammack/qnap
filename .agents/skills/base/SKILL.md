...
**CRITICAL: These limits are non-negotiable. Codex MUST check and enforce these limits for EVERY file created or modified.**
...
└── AGENTS.md                  # Codex instructions (references skills)
```
...
| `AGENTS.md` | Codex-specific instructions and skill references |
...
| Codex | `sk-ant-*` | `ANTHROPIC_API_KEY` |
...
**For any non-trivial task, Codex MUST automatically use iterative TDD loops.**
